...
const ExitConfirmModal: React.FC<ExitConfirmModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 z-[1000] flex items-center justify-center p-4 fade-in" onClick={onClose}>
            <div className="rounded-xl p-6 max-w-sm w-full shadow-2xl border" style={{ backgroundColor: theme.bgColor || (theme.isOriginal ? '#ffffff' : '#1e293b'), borderColor: theme.cardBorder || theme.palette[0] }} onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex justify-center gap-3">
                    <button 
                        ...
                        style={{
                            backgroundColor: theme.isOriginal ? '#f3f4f6' : 'rgba(255, 255, 255, 0.1)',
