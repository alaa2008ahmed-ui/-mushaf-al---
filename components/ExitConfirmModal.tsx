...
const ExitConfirmModal: React.FC<ExitConfirmModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 z-[1000] flex items-center justify-center p-4 fade-in" onClick={onClose}>
            <div className="rounded-xl p-6 max-w-sm w-full shadow-2xl border max-h-[95vh] overflow-y-auto" style={{ backgroundColor: modalBg, borderColor: theme.cardBorder || theme.palette[0] }} onClick={(e) => e.stopPropagation()}>
