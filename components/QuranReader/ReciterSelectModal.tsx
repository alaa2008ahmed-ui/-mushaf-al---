                ...
                <div className="p-3 overflow-y-auto flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                    {READERS.map(r => (
                        <button 
                            ...
                            className={`w-full text-right p-3 rounded-xl border-2 transition-all font-bold flex flex-col justify-center ${currentReader === r.id ? 'theme-accent-btn' : 'border-transparent hover:opacity-80'}`}
