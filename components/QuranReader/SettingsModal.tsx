            ...
            <div className={`modal-skinned w-full max-w-md sm:max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-modal-enter`} onClick={e => e.stopPropagation()}>
                ...
                <div className="p-3 space-y-2 overflow-y-auto text-center flex-1">
                    ...
                    <div className="border-b border-gray-200 dark:border-gray-700 py-1">
                        ...
                        <div className="mt-1">
                            <div className={`grid ${isLandscape ? 'grid-cols-3 sm:grid-cols-4 lg:grid-cols-5' : 'grid-cols-2 sm:grid-cols-3'} gap-2 p-1 themed-card-bg rounded-lg`}>
                                {[
                    ...
                    <div className="border-b border-gray-200 dark:border-gray-700 py-1">
                        ...
                        <div className={`grid ${isLandscape ? 'grid-cols-2 sm:grid-cols-3 lg:grid-cols-4' : 'grid-cols-1 sm:grid-cols-2'} gap-2 p-1 themed-card-bg rounded-lg mt-1`}>
                            {READERS.map(r => (
                                <button 
                                    key={r.id} 
                    ...
                    <div className="border-b pb-2 border-gray-200 dark:border-gray-700 space-y-2">
                        ...
                        <div className={`grid ${isLandscape ? 'grid-cols-5 sm:grid-cols-8 lg:grid-cols-10' : 'grid-cols-4 sm:grid-cols-6'} gap-1 p-1 themed-card-bg rounded-lg`}>
