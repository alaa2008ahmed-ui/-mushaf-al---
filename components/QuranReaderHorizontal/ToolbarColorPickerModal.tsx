...
const ToolbarColorPickerModal: React.FC<ToolbarColorPickerModalProps> = ({ onClose, onOpenModal, showToast, currentTheme, toolbarColors }) => {
    ...
    const toggleTransparentMode = (checked: boolean) => {
        ...
        localStorage.setItem('transparent_mode_horizontal', String(checked));
    ...
    const saveElementChanges = () => {
        ...
        const colors = JSON.parse(localStorage.getItem('toolbar_colors_horizontal') || '{}');
        ...
        localStorage.setItem('toolbar_colors_horizontal', JSON.stringify(colors));
