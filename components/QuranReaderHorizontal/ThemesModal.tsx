...
const ThemesModal: React.FC<ThemesModalProps> = ({ onClose, showToast }) => {
    const currentThemeId = localStorage.getItem('current_theme_id_horizontal') || 'default';
    ...
    const applyTheme = (themeId: string) => {
        ...
        localStorage.setItem('current_theme_id_horizontal', themeId);
        ...
        localStorage.setItem('toolbar_colors_horizontal', JSON.stringify(themeColors));
        localStorage.setItem('transparent_mode_horizontal', 'false');

        // Update quran_settings_horizontal to match the theme's colors and font
        const savedSettings = JSON.parse(localStorage.getItem('quran_settings_horizontal') || '{}');
        ...
        localStorage.setItem('quran_settings_horizontal', JSON.stringify(updatedSettings));
